...
public class Http 
{
    ...
    public static event HTTPResponse hTTPResponseEvent;
    ...
    static IEnumerator HTTPCall(string url, string json, string method)
    {
        using(UnityWebRequest request = new UnityWebRequest(url, method))
        {
            ...
            hTTPResponseEvent(request.downloadHandler.text, success);
    ...
    public  IEnumerator Get(string url, string urlEncoding)
    {
        using (UnityWebRequest req = UnityWebRequest.Get(url + urlEncoding))
        {
            ...
            hTTPResponseEvent(req.downloadHandler.text, sucessful);
        }
    }
